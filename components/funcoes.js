...
function listarEstoque() {
    ...
    produtos.forEach(produto => {
        ...
        var textnode = document.createTextNode("Nome do produto: "+nomeProduto);         
        node.appendChild(textnode);                              
        document.getElementById("myEst").appendChild(node);   

        var node2 = document.createElement("LI");                 
        var textnode = document.createTextNode("Codigo do produto: "+codigoProduto);         
        node2.appendChild(textnode);                              
        document.getElementById("myEst").appendChild(node2);   


        var node3 = document.createElement("LI");                 
        var textnode = document.createTextNode("Quantidade do produto: "+quantProduto)       
        node3.appendChild(textnode);                              
        document.getElementById("myEst").appendChild(node3);   
